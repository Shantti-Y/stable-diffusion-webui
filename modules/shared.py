...
options_templates.update(options_section(('saving-images', "Saving images/grids"), {
    ...
    "samples_filename_pattern": OptionInfo("", "Images filename pattern", component_args=hide_dirs).link("wiki", "https://github.com/Shantti-Y/stable-diffusion-webui/wiki/Custom-Images-Filename-Name-and-Subdirectory"),
    ...
    "grid_zip_filename_pattern": OptionInfo("", "Archive filename pattern", component_args=hide_dirs).link("wiki", "https://github.com/Shantti-Y/stable-diffusion-webui/wiki/Custom-Images-Filename-Name-and-Subdirectory"),
...
options_templates.update(options_section(('saving-to-dirs', "Saving to a directory"), {
    ...
    "directories_filename_pattern": OptionInfo("[date]", "Directory name pattern", component_args=hide_dirs).link("wiki", "https://github.com/Shantti-Y/stable-diffusion-webui/wiki/Custom-Images-Filename-Name-and-Subdirectory"),
...
options_templates.update(options_section(('sd', "Stable Diffusion"), {
    ...
    "CLIP_stop_at_last_layers": OptionInfo(1, "Clip skip", gr.Slider, {"minimum": 1, "maximum": 12, "step": 1}).link("wiki", "https://github.com/Shantti-Y/stable-diffusion-webui/wiki/Features#clip-skip").info("ignore last layers of CLIP network; 1 ignores none, 2 ignores one layer"),
...
options_templates.update(options_section(('optimizations', "Optimizations"), {
    ...
    "s_min_uncond": OptionInfo(0.0, "Negative Guidance minimum sigma", gr.Slider, {"minimum": 0.0, "maximum": 15.0, "step": 0.01}).link("PR", "https://github.com/Shantti-Y/stable-diffusion-webui/pull/9177").info("skip negative prompt for some steps when the image is almost ready; 0=disable, higher=faster"),
    "token_merging_ratio": OptionInfo(0.0, "Token merging ratio", gr.Slider, {"minimum": 0.0, "maximum": 0.9, "step": 0.1}).link("PR", "https://github.com/Shantti-Y/stable-diffusion-webui/pull/9256").info("0=disable, higher=faster"),
...
options_templates.update(options_section(('sampler-params', "Sampler parameters"), {
    ...
    'always_discard_next_to_last_sigma': OptionInfo(False, "Always discard next-to-last sigma").link("PR", "https://github.com/Shantti-Y/stable-diffusion-webui/pull/6044"),
